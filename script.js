...
function drawText() {
  ...
  if (frameNumber < 300) {
    ...
    context.fillText(
      "Hello Ekku, Happy Valentines Day 🥰💖",
      canvas.width / 2,
      canvas.height / 2
    );
  ...
  if (frameNumber > 600 && frameNumber < 900) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["I never thought I would find someone so beautiful and adorable"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "I never thought I would find such a pure and kind soul",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 3000 && frameNumber < 3300) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "Who helped me in all my lows and was happier then me in all my highs 🤗",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
